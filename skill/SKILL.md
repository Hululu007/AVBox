---
name: AVBox项目开发规范
description: 项目规则、通用原则、通用代码规范 + 项目文档地图(索引与按需检索约定)
---
...
| 文档 | 内容 | 何时读 |
| --- | --- | --- |
| `skill/avbox-mobile-ui-spec.md` | **活规范**：技术基线(§2)、信息架构与主题(§3)、各页面规范(§4)、视觉与组件约定(§5)、关键技术约束与已知坑(§6)、未决清单(§7)、历史索引(§8) | 改动 UI / 页面 / 播放内核 / 依赖前**必读**（只有约 290 行，读 §0–§7） |
