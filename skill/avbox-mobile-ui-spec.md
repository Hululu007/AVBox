...
- **卡片顺序(用户指定;2026-09-17 定稿为两组)**:组1 = 自动换线 → M3U8 净化 → 弹幕开关 → 弹幕 API → 长按倍速 → 缓冲时间 → 搜索线程;**组2** = 无痕模式 → 禁用手势控制 → 禁用导航动画。全页**共两组**,组间 28dp 间距。
